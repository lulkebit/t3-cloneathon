...
export function AttachmentList({
  ...
  const handleImageError = (index: number) => {
    setImageLoadErrors((prev) => new Set(prev).add(index.toString()));
  };
    ...
    <div className="mb-3">
      <AnimatePresence>
        {attachments.map((attachment, index) => {
          ...
          const hasImageError = imageLoadErrors.has(index.toString());
          ...
          return (
            ...
            >
              {isImage && !hasImageError && attachment.file_url ? (
                ...
                // Icon for non-images or images with errors
